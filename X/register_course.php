                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class=" boom">Course Name</label>
                                                <input type="text" name="course_name" class="form-control profile" placeholder="Enter your Course">
                                                <input type="hidden" name="id_holder" />                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="boom">Course Code</label>
                                                <input type="text" name="course_code" class="form-control profile" placeholder="Enter your Course Code">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="boom">Academic Year</label>
                                                <input type="text" name="academic_year" class="form-control profile" placeholder="Enter your Academic Year">
                                            </div>
                                        </div>
                                    </div>

                                     <button type="submit" name="register_course" class="btn btn-info btn-fill pull-left">Register Course</button>
