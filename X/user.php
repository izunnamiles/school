		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right norm">
                        <li>
                           <a href="">
                               <p>Account</p>
                            </a>
...
<?php $result = selector($connection, "SELECT * FROM company_tb WHERE id = '$id'")?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="edi_phone_no" value="<?php if(isset($value['Phone'])){ echo $value['Phone']; } ?>" class="form-control profile" name="phone_no" placeholder="Phone No.">
                                            </div>
                                        </div>
                ...
                <button type="submit" name="update" class="btn btn-info btn-fill pull-left">Update Profile</button>
            </div>
        </div>
        </form>
